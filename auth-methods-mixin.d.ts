 ...
 */
declare function AuthMethodsMixin<T extends new (...args: any[]) => {}>(base: T): T & AuthMethodsMixinConstructor;

interface AuthMethodsMixinConstructor {
  new(...args: any[]): AuthMethodsMixin;
}

export {AuthMethodsMixinConstructor};
...
interface AuthMethodsMixin {
   ...
   * or undefined.
   */
  _getAuthType(): String|null|undefined;
